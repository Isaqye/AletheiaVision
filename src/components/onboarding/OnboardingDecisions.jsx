...
export default function OnboardingDecisions() {
  const decisions = [
    {
      level: 'Operacional',
      desc: 'Identificar tarefas pendentes e controle de checklist individual por editora.',
      badgeStyle: 'bg-cyan-brand/10 text-blue-petrol border border-cyan-brand/20',
      borderStyle: 'border-l-4 border-l-cyan-brand'
    },
    {
      level: 'Tático',
      desc: 'Priorizar implantações com maior volume de artigos e gerenciar gargalos de integração.',
    ...
    {
      level: 'Estratégico',
      desc: 'Mapear perfis com potencial de expansão, taxa de retenção e acompanhamento de NPS.',
  ...
  return (
    <section className="bg-white rounded-xl shadow-sm border border-slate-200/80 p-5 hover:shadow-md transition-all">
      <div className="flex items-center justify-between mb-4 border-b border-slate-100 pb-3">
        <h3 className="text-md font-bold text-blue-dark">Decisões Gerenciais Apoiadas — Onboarding</h3>
      </div>
